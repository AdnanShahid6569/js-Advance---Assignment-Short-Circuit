...
//          --> hello * 1 = NaN + 2 = NaN  ||  3 && result    ||  4test   Result--> result
console.log(exp12);


// q 13
let exp13 = 5 * (a++ || false) + 2 && (false + 'test') || 3 * 'end' && 4;
//         5 *    (5 || false) --> 5 + 2  &&  falsetest  || NaN  &&  4
//           27    &&    falstest --> falsetest    Result ==> falsetest
console.log(exp13);


// q 14
let exp14 = (false + 'abc') * 2 || (--a + 1) * 'start' + 3 && 4 || 'end';
//              (falsetest) * 2 --> NaN  || (4 + 1) * start + 3  --> NaN  ||  "end"
//                 NaN    ||   NaN    ||  end       Result ==> end
console.log(exp14);


// q 15
let exp15 = (0 + 'foo') * 3 + (true && "result") || "start" + (++a + 1) * 4;
//              (0 + foo) * 3 --> NaN  + (1 && result) --> result || start + (6 + 1) * 4 --> start28
//                  NaN + "result" --> "NaNresult"  ||   start28    Result ==> "NaNresult"
console.log(exp15);


// q 16
let exp16 = 2 *'end' || (false && true) || 'start' + (--a + 2) * 5 && null;
//              2 * 'end' --> NaN  || (0 && 1) --> 0 || "start" + (4 + 2) * 5 --> "start30" && null 
//                   NaN           ||          0      ||    "start30" && null    Result ==> null
console.log(exp16);


// q 17
let exp17 = 3 + 2 * ('test' + a--) && (false + 3) * 5 || 0 + 'value'&& 4;
//            6   *  ("test5") --> NaN  &&   (3) * 5 --> 15  || "0value"  &&  4;
//                      NaN   &&   15 --> NaN    ||  "0value"  &&  4   Result ==> 4
console.log(exp17)


// q 18
let exp18 = 'start' && (false || 2 * 'end') || (++a + 1) * 3 + 'result' && 0;
//             'start'  &&  (0 || NaN) --> NaN (7) * 3 + "result" --> "21result" && 0;
//                  NaN    ||  "21result"  &&  0     Result ==>  0
console.log(exp18);
...
//              ((6) && "foo") --> "foo" || (8) * (3) + "test" --> "24test" && 7
//                  "foo"   ||  "24test"  &&  7     Result ==> 'foo'
console.log(exp19);


// q 20
let exp20 = 2 * 3 +'hello' && (false + ++a) * 'result' || 'end' + 5 || 0;
//              6 + "hello" --> hello && (6) * "result" --> NaN || "end" + 5 --> "end5" || 0;
//                      "6hello"  &&  NaN --> NaN  || "end5"  ||  0  Result ==> "end5"
console.log(exp20);


// q 21
let exp21 = 5 * (true + ++a) && ('test' + false) || 7 * (true + 2) + 'value';
//              5 * (7) --> 35 && ("testfalse") || 7 * (3) + "value" --> "21value";
//                   35 && "testfalse"  ||  21value   Result ==> "testfalse"
console.log(exp21);


// q 22
let exp22 = 'foo' + 4 && (++a + 1) * 'start' || 5 + 6 * (false + true) && "test";
//              "foo4" && (7) * "start" --> NaN  || 5 + 6 * (1) --> 11 && "test";
//                  NaN   ||  11 && "test"   Result ==> "test"
console.log(exp22);


// q 23
let exp23 = (false && 2) || (a++ + 1) * 'end' && 'start' || 4 * 5 && 'result';
//              (0 && 2) --> 2 || (6) * "end"--> NaN && 'start' || 20 && "result" 
//                  2 || NaN --> 2 && "start" --> 'start' || 20 &&"result"
//                          "start" || "result"     Result ==> "result"
console.log(exp23);


// q 24
let exp24 = 3 + 2 * 'test' || (false + a--) * 'hello' && 'world' + 1 || 2;
//              6 * "test" --> "6test" || (5) * "hello" -- NaN  && "world" + 1 --> "world1" || 2
//                  NaN || NaN --> NaN && "world1" || 2 --> 2
//                          NaN   ||  2
console.log(exp24);
...
//              (7) * (0 || 5) --> 35  && 5 || "start1test" --> "start1test"  && 0
//                      35  &&  5 --> 5    ||   "start1test" && 0 --> 0
//                          5     ||    0
console.log(exp25);
...
//           "hello" && 6 + (5) -> 13 --> 13   || (1) * "Result" -> NaN + "end" --> NaN
//                  12     ||  NaN
console.log(exp26);
...
//           3 * "test3" --> NaN  &&  (0 || "value")  || "start" + 5;
//                      NaN  &&  "value" --> NaN    ||   "start5"   Result ==> "start5"
console.log(exp27);


// q 28
let exp28 = (false + 1) * "hello" || 3 + (a-- && 5) * "result" || "world";
//              (1) * "hello" -> NaN || 3 + (5 && 5) * "result" -> 3 + NaN -> NaN  || "world";
//                  NaN  ||  NaN  || "world"
console.log(exp28);
...
//                  "start" + 2 (1 || 1) ->"start" + 2  --> "start2" && (0 || "value") * 5 + "Result"
//             "start2"  &&  (0 || "value") -> "value" * 5 + "result"  -->   NaN + "result" -> "NaNresult"
//                "start2" &&  "NaNresult"     Result ==> "NaNresult"
console.log(exp29);


// q 30
let exp30 = (true + 3) * "test" || 1 * 5 && (false + 'value') + 'end' || a--;
//            (4) * test -> NaN || 5 --. 5  && ("falsevalue") + "end" --> "falsevalueend" || 5 --> 5
//                      5   &&  "falsevaluerend"    Result ==> "falsevaluerend"
console.log(exp30);


// q 31
let exp31 = 3 + "end" || 2 * "test" && (++a + true) || "start" + 1;
//                 3 + "end" || 2 * "test" = NaN --> "3end"   &&   (7) || "start1" = 7
//                      "3end"   &&  7   Result ==> "3end"
console.log(exp31);
...
//              (3) * 1 =  3  || NaN + 2 = NaN  &&  ("falsetest")
//                  3   ||  "falsetest"   Result  ==> 3
console.log(exp32);


// q 33
let exp33 = 2 + 3 && ('end' + a++) || (false + "test") * 4 && 5;
//            5 && ("end5") --> "end5" || ("falsetest") * 4 -> NaN && 5;
//                  "end5"  || NaN && 5 --> NaN
//                      "end5"  ||  NaN      Result ==> "end5"
console.log(exp33);


// q 34
let exp34 = 'hello' + 4 * (false + a--) || 3 && "start" + 1 || (true + "test");
//              "hello" + 4 * (5) = 20 --> "hello20" || 3 && "start1" || ("truetest")
//                  "hello20"   || "start1" || "truetest"    Result ==> "hello20"
console.log(exp34);


// q 35
let exp35 = "start" && (a-- || "test") * 4 + 5 && (false + 'end') || 2;
//              "start" && (5 || "test") = 5 -> 5 * 4 + 5 = 25 --> 25 && ("falseend") || 2;
//                      25   &&  "falseend"   Result ==> "falseend"
console.log(exp35);
